        ...
        <main className='main-container-about'>
          <div className='content-about'>
            <div className='text-about'>
              ...
              <p>
                A Santa Rita Administradora foi fundada por profissionais com
                mais de 10 anos de experiência em administração condominial.
                Desde o início, nosso compromisso foi oferecer um atendimento
                excepcional, baseado em transparência, eficiência e
                profissionalismo.
              </p>
              <p>
                Com o passar dos anos, crescemos reconhecidos pela nossa
                dedicação em entender as necessidades de cada condomínio. Hoje,
                com uma equipe especializada em diversas áreas, como
                administração, finanças, contabilidade e apoio jurídico,
                continuamos a simplificar a gestão condominial, reduzindo custos
                e facilitando o trabalho do síndico.
              </p>
              ...
              <section aria-labelledby='missao'>
                <div style={{ display: 'flex' }}>
                  ...
                  />
                  <h2 style={{ fontSize: '30px', marginTop: '32px' }}>
                    MISSÃO
                  </h2>
                </div>
                <p>
                  Atender com excelência às necessidades de cada cliente,
                  através de um modelo de atuação pautado pela ética, inovação,
                  sustentabilidade, compromisso com o serviço e valorização do
                  ser humano.
                </p>
              </section>
            ...
            <div className='logo-santa-rita-about'>
              <img
                src={Logo}
                alt='Logo da Santa Rita Administradora de Condomínios'
              />
            </div>
          </div>
              ...
              <div className='experience'>
                <div className='experience-content'>
                  ...
                  <div className='experience-text'>
                    ...
                    <p>
                      Nossa experiência é o que nos define. Com mais de 10 anos
                      em administração condominial, nossa equipe oferece
                      serviços de alta qualidade em gestão e suporte. Escolha a
                      Santa Rita Administradora para uma gestão eficiente e
                      confiável.
                    </p>
                  </div>
                </div>
                ...
                <div className='experience-content'>
                  ...
                  <div className='experience-text'>
                    ...
                    <p>
                      ...
                      soluções precisas e eficazes. Conte com nossa expertise
                      para um serviço de alta qualidade e confiança.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className='experience-content'>
                  ...
                  <div className='experience-text'>
                    ...
                    <p>
                      ...
                      comunicação clara e ética, garantimos que todas as
                      operações sejam visíveis e compreensíveis, promovendo a
              ...
              <div className='experience'>
                <div className='experience-content'>
                  ...
                  <div className='experience-text'>
                    ...
                    <p>
                      Entendemos que cada condomínio é único. Por isso,
                      oferecemos soluções sob medida para atender às suas
                      necessidades específicas, garantindo uma gestão eficiente
                      e satisfatória.
                    </p>
                  </div>
                </div>
                ...
                <div className='experience-content'>
                  ...
                  <div className='experience-text'>
                    ...
                    <p>
                      ...
                      nossos clientes. Com uma abordagem focada na qualidade e
                      no atendimento, garantimos serviços de alta qualidade e
                      confiança.
                    </p>
                  </div>
                </div>
